...
function getTopping(runningTotal, text1) {
    ...
    getVeggies(runningTotal, text1) //sends running variables over to getVeggies()
};
...
function getVeggies(runningTotal, text1) {
    ...
    var veggieTotal = selectedVeggie.length;  //each selected veggie adds a dollar to the price
