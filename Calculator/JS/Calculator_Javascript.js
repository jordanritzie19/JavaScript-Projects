...
const Calculator = {
    ...
    First_Operand: null,     //this will hold the first operand for any expressions, null for now
    Wait_Second_Operand: false,     //this checks whether or not the second operand has been inputted
    operator: null,  //This will hold the operator, null for now
};
...
function Handle_Operator(Next_Operator) {
    ...
    //in Calculator.First_Operand if ti doesn't already exist.
    const Value_of_Input = parseFloat(Display_Value);
    //checcks if an operator already exists and if Wait_second_operand is true,
