...
window.alert(warning)                           //this gives the pop up advising about sensitive content

document.write("The " + team_name + " possess the best group of " + position_group + "in the NFL with the trio of "
+ wr1 +', ' + wr2 + ' and ' + wr3)              //writing a statement concatenating strings + variables
